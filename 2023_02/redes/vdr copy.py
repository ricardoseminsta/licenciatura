class Roteador:
    def __init__(self, nome):
        ...
        self.tabela_rotas[self.nome] = (0, f"{self.nome}-{self.nome}")
...
# Exemplo de uso
    ...
    roteador_A.adicionar_rota("C", 3)
    roteador_A.adicionar_rota("D", 3)

    roteador_B = Roteador("B")
    roteador_B.adicionar_rota("A", 1)
    roteador_B.adicionar_rota("b", 2)
    roteador_B.adicionar_rota("C", 2)

    roteador_C = Roteador("C")
    roteador_C.adicionar_rota("A", 3)
    roteador_C.adicionar_rota("B", 2)
